...
/* ---------------- App-wide icon set (inline SVG, stroke=currentColor so
   each caller controls color/size via CSS â€” one small library instead of
...
const ICONS = {
  ...
  controls: `<path d="M4 7h16M4 17h16"/><circle cx="9" cy="7" r="2" fill="currentColor"/><circle cx="15" cy="17" r="2" fill="currentColor"/>`,
